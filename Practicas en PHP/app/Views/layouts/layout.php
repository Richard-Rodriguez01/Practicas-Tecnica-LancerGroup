...
<head>
  ...
  <title>AdminBook | Blank Page</title>
...
<div class="wrapper">
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Call me whenever you can<?php echo base_url(); ?>.</p>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>/gallery.html" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>/kanban.html" class="nav-link">
            <i class="nav-icon bi bi-plus-circle-dotted"></i>
              <p>
                Add Author
              </p>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="https://richard-rodriguez01.github.io/Portfolio/">Richard Rodriguez</a>.</strong> All rights reserved.
  </footer>
